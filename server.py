...
def claude_chat():
    try:
        ...
        full_system += (
            ...
            '⚠️ EVENTO vs LEMBRETE PESSOAL — REGRA CRITICA:\n'
            'A AGENDA e um MURAL COMPARTILHADO da turma toda (todo mundo ve). '
            'NUNCA crie [SALVAR_EVENTO] quando o usuario pede um LEMBRETE PESSOAL/PRIVADO. '
            'Use [SALVAR_MEMORIA tipo=pessoal] no lugar.\n'
            '  - "me avise / me lembre / anota pra mim / nao deixa eu esquecer / so pra mim" -> [SALVAR_MEMORIA tipo=pessoal] (NAO vai pra agenda)\n'
            '  - "agenda / marca na agenda / coloca no mural / poe no calendario" -> [SALVAR_EVENTO] (vai pra agenda compartilhada)\n'
            '  - Se o aviso NAO tem data fixa de calendario (ex.: "me lembra de levar EPI amanha") -> memoria pessoal.\n'
            '  - Se ha data clara E faz sentido a turma toda ver (consulta, viagem, HE, aniversario, reuniao) -> evento.\n'
            '  - Em DUVIDA, prefira memoria pessoal e PERGUNTE: "isso e so pra voce ou quer que apareca no mural da turma?"\n\n'
